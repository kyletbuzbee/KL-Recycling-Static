...
const MapView = ({ apiKey, locations, selectedIndex, onMarkerClick }: { apiKey: string; locations?: Location[]; selectedIndex?: number | null; onMarkerClick?: (index: number) => void }) => {
...
function MapComponent({ locations, selectedIndex, onMarkerClick }: MapComponentProps) {
  ...
  return <MapView apiKey={apiKey} locations={locations} selectedIndex={selectedIndex} onMarkerClick={onMarkerClick} />;
}
