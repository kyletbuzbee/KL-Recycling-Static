...
import { MaterialDetail } from "@/types/content";
...
const MaterialDetailPage: FC<MaterialDetailPageProps> = ({ material }) => {
  const mainOffice = locations.find((loc) => loc.id === 1);
  const mainPhoneNumber = mainOffice ? mainOffice.phone : "(903) 592-8288";
      ...
      <section className="py-20 bg-gradient-to-r from-royal-blue-600 to-electric-blue-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <a href={`tel:${mainPhoneNumber}`} className="border-2 border-white text-white font-bold py-4 px-8 rounded-xl hover:bg-white hover:text-royal-blue-600 transition-colors text-lg">
              Call {mainPhoneNumber}
            </a>
          </div>
