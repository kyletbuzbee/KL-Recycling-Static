  ...
  return (
    <Layout>
      ...
      <section id="how-to-apply" className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Ready to Join Our Team?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Download the appropriate application form to start your journey with K&L Recycling.</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* General Application Card */}
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">General Application</h3>
              <p className="text-gray-600 mb-6">For all non-driving positions, including yard staff, administrative, and management roles.</p>
              <a href="/assets/careers/Employment application.pdf" download className="inline-block bg-royal-blue-600 hover:bg-royal-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors w-full text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Driver Application</h3>
              <p className="text-gray-600 mb-6">For all commercial driving positions. A valid CDL is required.</p>
              <a href="/assets/careers/Driver-Application.pdf" download className="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors w-full text-center">
      ...
      <section className="py-20 bg-gradient-to-r from-royal-blue-600 to-electric-blue-600 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6">Let's Start Your Career</h2>
