...
const ProcessSteps = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Each vehicle is drained, crushed, and weighed.",
    },
    {
      step: "04",
...
const TestimonialsSection = () => {
  const testimonials = [
    ...
    {
      quote: "We've used K&L mobile crushing for our salvage yard for over 5 years. They handle all the permits and environmental compliance, and their payment process means we can reinvest in our business immediately.",
...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Payments are based on current market values for scrap metal content.",
    },
  ];
...
const MobileCrushingPage: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO title="Mobile Car Crushing & On-Site Processing Service | On-Site Processing" description={`Professional mobile car crushing service across TX, OK, LA, NM, KS, and AR. Fully insured, EPA-compliant. Free 2-week quote. Call (800) 533-8081.`} keywords="mobile car crushing, on-site auto crushing, mobile scrap processing, vehicle crushing service, Texas car crushing" twitterCard="summary_large_image" />
      ...
      <section className="bg-gradient-to-br from-royal-blue-900 to-electric-blue-900 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-8">Insured crews · EPA-compliant disposal</p>
      ...
      <section className="py-16 bg-gradient-to-r from-royal-blue-600 to-electric-blue-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg text-blue-100 max-w-2xl mx-auto mb-8">Turn your automotive inventory into immediate revenue with our professional mobile crushing service.</p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link href="/contact" className="bg-white text-royal-blue-600 font-bold py-4 px-8 rounded-xl hover:bg-gray-100 transition-colors text-lg">
