...
import { materialsCatalog } from "../data/materials-catalog";
...
const materialsData = [
  ...
  },
  {
    ...
    category: "non-ferrous",
    image: "/assets/non-ferrous/stainless_steel.jpg",
...
const MaterialsPage: FC = () => {
  ...
  return (
    <Layout>
      ...
      <SubpageHero title="Materials We Buy" subtitle="Competitive value for all ferrous and non-ferrous metals. Market-based rates; contact for current quotes." />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredMaterials.map((material, index) => (
              <div key={material.name} className="bg-white rounded-lg shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay={index * 100}>
                {material.image && <Image src={material.image} alt={material.name} width={400} height={250} className="w-full h-48 object-cover" />}
                <div className="p-6">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {prohibitedItems.map((item, index) => (
              <div key={item.name} className="bg-white p-6 rounded-lg shadow-lg border border-red-200 bg-red-50" data-aos="fade-up" data-aos-delay={index * 50}>
