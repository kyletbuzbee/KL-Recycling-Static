    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-royal-blue-900 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-6xl font-black mb-6">Recycling for a Greener Tomorrow</h1>
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">For over 56 years, our mission has been to conserve natural resources and build a more sustainable future for East Texas.</p>
        </div>
      </section>

      {/* Our Impact by the Numbers */}
      <section id="impact-stats" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">Our Impact by the Numbers</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">See the real environmental difference we're making every day</p>
          </div>

          <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            <div className="text-center">
              <AnimatedCounter value={85000} suffix="" title="Tons Recycled Annually" className="mb-8" />
              <p className="text-lg text-gray-700 leading-relaxed">That's the weight of over 8,500 cars - all diverted from landfills</p>
            </div>

            <div className="text-center">
              <AnimatedCounter value={125000} suffix="" title="Tons of CO₂ Emissions Saved" className="mb-8" />
              <p className="text-lg text-gray-700 leading-relaxed">Equivalent to removing 23,000 cars from the road for one year</p>
            </div>

            <div className="text-center">
              <AnimatedCounter value={420000000} suffix="" title="kWh of Energy Conserved" className="mb-8" />
              <p className="text-lg text-gray-700 leading-relaxed">Power for 37,500 homes for an entire year</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <Image src="/assets/certifications-logo/rema-certified-logo.png" alt="REMA Certified" width={400} height={200} className="w-full h-auto" />
            </div>
            <div>
              <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-6">Our Commitment to the Highest Standards</h3>
              <p className="text-lg text-gray-600 leading-relaxed">As a REMA Certified facility, K&L Recycling adheres to the industry's most stringent standards for safety, environmental responsibility, and operational excellence. This certification is your assurance that your materials are processed with the utmost integrity, contributing to a truly circular economy.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 md:p-12">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <div className="inline-flex items-center border-2 border-gray-600 text-gray-600 hover:bg-gray-50 font-bold py-4 px-8 rounded-xl transition-all duration-300 cursor-pointer">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Calculate Your Own Impact</h2>
            <p className="text-xl text-gray-700 mb-8">Curious about the positive environmental effect of your own recycling efforts? Use our interactive tool to see how your scrap materials translate into real-world energy and resource savings.</p>
            <Link href="/impact-calculator" className="inline-flex items-center bg-royal-blue-600 hover:bg-royal-blue-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
